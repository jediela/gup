...
#
# Student: Jediel Antalan, 1008192796, antalanj, j.antalan@mail.utoronto.ca
#
...
# - Heart can only be picked up once per game, once picked up it disapears into nowhere magiccc
# - Bullet automatticaly shoots again once player is hit, so for instance if player is hit close to the shooting enemy, the player can die pretty quickly
# - ^ sorry i was not able to show the above, my throat is bad and mars keeps crashing... :(
#
#
#####################################################################
...
# A)
# B)
# C) 2 ADDITIONAL OBJECTS - 2 ENEMIES 1 HEART

# ADDITIONAL FEATURES  (Need total of 5 marks)
# (2)	B) MOVING OBJECTS (1 MOVING ENEMY, 1 MOVING HEART) 	
# (2)	E) ENEMIES THAT SHOOT BACK (1 SHOOTING ENEMY 1 WALKING ENEMY)
# (1)	H) DOUBLE JUMP 
